        <figure class="details-page-thumbnail">
            <img src="images/project-cover.webp" alt="">
        </figure>
        <div class="container pb-5">
            <div class="page-header-wrapper">
                <span class="category">Arts and Design</span>
                <h1 class="page-title">Moon and Dragon Builder</h1>
            </div>
            <div class="row gy-4">
                <div class="col-lg-8 col-md-12 col-sm-12">
                    <h2 class="block-tittle"> Project Overview
                    </h2>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <aside class="aside-information">
                        ...
                        <ul>
                            ...
                            <li><span>Role:</span>Designing, Developement, SEO</li>
                            <li><span>Type:</span>Buddhist Arts</li>
                            <li><span>Technology:</span>HTML, CSS, Bootstrap, Php Laravel</li>
                        </ul>
                        <div class="custom-buttons mt-5">
                            <a href="https://moonanddragonbuilder.com" target="_blank">VIEW SITE <i class="ps-2 fa-solid fa-link"></i></a>
                        </div>
                    </aside>
                </div>
            </div>
